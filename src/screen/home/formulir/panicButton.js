      ...
      .then(ok => {
        ...
        if (!ok.success) {
          ...
          setBasicAlertProps({
            ...
            basicAlertMessage: ok.message,
            basicAlertOnOk: () => {
              props.navigation.navigate('formulir.card',)
              closeBasicAlert();
            },
            basicAlertOkBtnOnly: true,
        ...
        {isLoading ? (
          ...
          <View
            ...
            <Text
              ...
              Dengan Penumpang {`${paramsData.penumpangs.length}`} orang dan 1{' '}
            ...
            <View>
              <Text
                ...
                "Terimakasih banyak telah menggunakan aplikasi kami! Dukungan Anda sangat berarti bagi kami.
                 Semoga aplikasi ini terus bermanfaat bagi Anda. Sampai jumpa di perjalanan selanjutnya!"
              </Text>
            </View>
            <View
              style={
