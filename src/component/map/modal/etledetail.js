...
export default forwardRef(({etleDetail, direction, ...props}, ref) => {
              ...
              <View
                ...
                <View style={{}}>
                  <Text
                    ...
                    ETLE {etleDetail.etleDetail?.vms_etle}
                  </Text>
                  <Text
                    style={{
                      color: '#4E4E4E',
                    ...
                    {etleDetail.etleDetail?.address_etle}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <WebView
                    source={{uri: etleDetail.etleDetail?.link_etle}}
                    style={{
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        ...
                        direction &&
                          direction({
                            latitude: parseFloat(
                              etleDetail.etleDetail?.lat_etle,
                            ),
                            longitude: parseFloat(
                              etleDetail.etleDetail?.lng_etle,
                            ),
                          });
                      }}
                      style={{
