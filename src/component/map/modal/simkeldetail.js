...
export default forwardRef(({simkelDetail, direction, ...props}, ref) => {
              ...
              <View
                ...
                <View style={{}}>
                  <Text
                    ...
                    {simkelDetail.simkelDetail?.name_sim_keliling}
                  </Text>
                  ...
                  <View style={{flex: 3, marginRight: 20}}>
                    <TouchableOpacity
                      onPress={() => {
                        ...
                        direction &&
                          direction({
                            latitude: parseFloat(
                              simkelDetail.simkelDetail?.latitude,
                            ),
                            longitude: parseFloat(
                              simkelDetail.simkelDetail?.longitude,
                            ),
                          });
                      }}
                      style={{
                    ...
                    <View
                      ...
                      <Text
                        ...
                        {simkelDetail.simkelDetail?.address}
                      </Text>
                    </View>
                    <View
                      style={{
