...
export default forwardRef(({restAreaDetail, direction, ...props}, ref, ) => {
              ...
              <View
                ...
                <View style={{}}>
                  <Text
                    ...
                    {restAreaDetail.restAreaDetail?.fasum_name}
                  </Text>
                  ...
                  <View style={{flex: 3, marginRight: 20}}>
                    <TouchableOpacity
                      onPress={() => {
                        ...
                        direction &&
                          direction({
                            latitude: parseFloat(
                              restAreaDetail.restAreaDetail?.fasum_lat,
                            ),
                            longitude: parseFloat(
                              restAreaDetail.restAreaDetail?.fasum_lng,
                            ),
                          });
                      }}
                      style={{
                    ...
                    <View
                      ...
                      <Text
                        ...
                        {restAreaDetail.restAreaDetail?.fasum_address}
                      </Text>
                    </View>
                    <View
                      style={{
